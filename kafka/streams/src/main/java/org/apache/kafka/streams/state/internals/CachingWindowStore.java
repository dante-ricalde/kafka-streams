...
class CachingWindowStore<K, V> extends WrappedStateStore.AbstractStateStore implements
    WindowStore<Bytes, byte[]>, CachedStateStore<Windowed<K>, V> {
    ...
    private void initInternal(final ProcessorContext context) {
        ...
        final String topic = ProcessorStateManager
            .storeChangelogTopic(context.applicationId(), underlying.name());
        ...
        cache.addDirtyEntryFlushListener(name, new ThreadCache.DirtyEntryFlushListener() {
            ...
            public void apply(final List<ThreadCache.DirtyEntry> entries) {
                for (final ThreadCache.DirtyEntry entry : entries) {
                    ...
                    final Windowed<K> windowedKey = WindowKeySchema
                        .fromStoreKey(binaryWindowKey, windowSize, serdes);
