 ...
 */
class ChangeLoggingWindowBytesStore extends WrappedStateStore.AbstractStateStore implements
    ...
    public void put(final Bytes key, final byte[] value, final long windowStartTimestamp) {
        ...
        changeLogger.logChange(WindowKeySchema
            .toStoreKeyBinary(key, windowStartTimestamp, maybeUpdateSeqnumForDups()), value);
    }
