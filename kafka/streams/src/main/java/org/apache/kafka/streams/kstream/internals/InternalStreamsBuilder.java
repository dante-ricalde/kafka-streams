...
public class InternalStreamsBuilder implements InternalNameProvider {
    ...
    public <K, V, S extends StateStore> KTable<K, V> table(final String topic,
        ...
        final TableSourceNode.TableSourceNodeBuilder<K, V, S> tableSourceNodeBuilder = TableSourceNode
    ...
    private OptimizableRepartitionNode createRepartitionNode(final String repartitionTopicName,
        ...
        final OptimizableRepartitionNode.OptimizableRepartitionNodeBuilder repartitionNodeBuilder = OptimizableRepartitionNode
